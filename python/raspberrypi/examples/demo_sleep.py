...
'''
  # @file demo_sleep.py
  # @brief  After collecting 20 sensor data, control the sensor to sleep for 2s. At this time, the sensor will be in low-power mode,
  # @n the gyroscope and accelerometer will stop working, and then wake up.
