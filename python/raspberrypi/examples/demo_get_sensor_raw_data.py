...
'''
  # @file demo_get_sensor_raw_data.py
...
if __name__ == "__main__":
  ...
  '''
  icg.enable_sensor(icg.eAXIS_ALL)
  ...
  while True:
    ...
    '''
    raw_data = icg.get_raw_data(icg.RAW_DATA_LENGTH)
    lin = ['%02X' % i for i in raw_data]
    print(" ".join(lin))

    print("RAW_DATA_AX_H_INDEX = %02X"%raw_data[icg.RAW_DATA_AX_H_INDEX])
    print("RAW_DATA_AX_L_INDEX = %02X"%raw_data[icg.RAW_DATA_AX_L_INDEX])
    print("RAW_DATA_AY_H_INDEX = %02X"%raw_data[icg.RAW_DATA_AY_H_INDEX])
    print("RAW_DATA_AY_L_INDEX = %02X"%raw_data[icg.RAW_DATA_AY_L_INDEX])
    print("RAW_DATA_AZ_H_INDEX = %02X"%raw_data[icg.RAW_DATA_AZ_H_INDEX])
    print("RAW_DATA_AZ_L_INDEX = %02X"%raw_data[icg.RAW_DATA_AZ_L_INDEX])
    print("RAW_DATA_T_H_INDEX  = %02X"%raw_data[icg.RAW_DATA_T_H_INDEX])
    print("RAW_DATA_T_L_INDEX  = %02X"%raw_data[icg.RAW_DATA_T_L_INDEX])
    print("RAW_DATA_GX_H_INDEX = %02X"%raw_data[icg.RAW_DATA_GX_H_INDEX])
    print("RAW_DATA_GX_L_INDEX = %02X"%raw_data[icg.RAW_DATA_GX_L_INDEX])
    print("RAW_DATA_GY_H_INDEX = %02X"%raw_data[icg.RAW_DATA_GY_H_INDEX])
    print("RAW_DATA_GY_L_INDEX = %02X"%raw_data[icg.RAW_DATA_GY_L_INDEX])
    print("RAW_DATA_GZ_H_INDEX = %02X"%raw_data[icg.RAW_DATA_GZ_H_INDEX])
    print("RAW_DATA_GZ_L_INDEX = %02X"%raw_data[icg.RAW_DATA_GZ_L_INDEX])
    print("")
    time.sleep(1)